...
function fillColor() {
  ...
  sliderTrack.style.background = "linear-gradient(to right, #F1F1F1 ".concat(percent1, "% , #1A202C ").concat(percent1, "% , #1A202C ").concat(percent2, "%, #F1F1F1 ").concat(percent2, "%)");
}
...
var tlCompareIcon = new TimelineMax(); // On hover
...
$('.compare-icon').each(function () {
  ...
  $(this).on('mouseenter', function () {
    var thisIcon = $(_this);
    var bottomArrow = thisIcon.find('.bottom-arrow');
    var topArrow = thisIcon.find('.top-arrow');
    tlCompareIcon.to(topArrow, 0.5, {
      x: '-12'
    }).to(bottomArrow, 0.5, {
      x: '12'
    }, '-=0.5');
...
$('.compare-icon').each(function () {
  ...
  $(this).on('click', function () {
    ...
    if (!isClicked) {
      tlCompareIcon.to(bottomArrow, .5, {
        fill: 'green'
      }).to(topArrow, .5, {
        fill: 'green'
      }, '-=0.5');
...
$('.product-color-checkbox').each(function () {
  ...
  $(this).on('click', function () {
    var color = $(_this4).attr("data-color");

    if ($(_this4).is(':checked')) {
      $(_this4).prev().append('<i class="las la-check"></i>');
      $('.display-selected-colors').append("<div class=\"color my-2 ".concat(color, "\"><i class=\"las la-times\" onclick=\"removeEl(this, ").concat(color, ")\"></i> <span class=\"selected-color\">").concat(color, "</span></div>"));
    } else {
      $(_this4).prev().find('.las').remove();
      $('.display-selected-colors').find(".".concat(color)).remove();
    }
  });
}); // Responsive menu
...
$('.slide-indicators').each(function () {
  $(this).on('mouseenter', function () {
    console.log('test');
    var previousSlideIcon = $(this).find('.slide-icon');
    var previousSlideIconStroke = previousSlideIcon.next();
    tlSlide.to(previousSlideIcon, {
      fill: '#000'
    });
...
/******/ 	__webpack_require__.O(undefined, ["dist/app"], () => (__webpack_require__("./src/_price-range-slider.js")))
